...
export default function Contact({
  ...
  return (
    ...
    >
      ...
      <div className="contactMainLayout">
        ...
        <section className="contactHero">
          <div className="contactHeroContent">
            ...
            <h2>
              Where{" "}
              <span className="contactHeroAccent">
                ideas
              </span>{" "}
              turn into{" "}
              <span className="contactHeroAccent">
            ...
            <p>
              Whether you have a question, an idea, or
              simply want to explore a potential
              collaboration, I'm always open to meaningful
              conversations.
            </p>
          </div>
        </section>
